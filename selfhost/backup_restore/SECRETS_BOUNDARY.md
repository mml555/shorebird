...
| the schema the image expects | a restore onto a newer image runs its migrations against the restored schema. Restore onto the image the backup came from, then upgrade. |
