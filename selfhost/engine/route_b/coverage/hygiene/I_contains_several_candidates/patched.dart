...
class Shadow {
  ...
  String value() {
    ...
    final shorebirdReceiver1 = Shadow.other;
    final shorebirdReceiver2 = Shadow.other;
    return self.label.isEmpty ||
            shorebirdReceiver0.label.isEmpty ||
            shorebirdReceiver1.label.isEmpty ||
            shorebirdReceiver2.label.isEmpty
        ? 'X'
        : label;
  }
}
