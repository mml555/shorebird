...
mixin Ticker on Base {
  // E1. Does this force the MIXIN-APPLICATION CLONE
  // (_Leaf&Base&Ticker.close) to be compiled, or only Ticker.close itself?
  // The clone is what the hierarchy selects, so only the second question
