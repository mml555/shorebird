...
class Leaf extends Base with Ticker {
  ...
  // E3. A synthetic compilation ROOT. Not reachable from `main`, kept by
  // `vm:entry-point`, and its body is a genuine `super.close()` -- which is what
  // forced the mixin-application clone to be compiled in arm B. A dead BRANCH
  // would not do: TFA makes its own reachability decisions, and arm C's release
  // already proves a merely-retained name is not enough.
