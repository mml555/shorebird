// SL1-G4 host: the same patch-defined subclass through five call shapes, each
// with a HOST subtype control beside it.
//
...
const String host = 'package:dynamic_modules/g4_host.dart';
...
/// The non-patch control subtype.
class HostChild extends Base {
  @pragma('vm:never-inline')
  @pragma('vm:entry-point')
  @override
  String execute() => 'HOST-CHILD';
}
...
Future<void> main(List<String> args) async {
  ...
  print('--- CONTROL: HostChild ---');
  shape('1_virtual', 'HOST-CHILD', s1_virtual(hc), 'HostChild.execute', moduleUri, isPatch: false);
  shape('2_monomorphic', 'HOST-CHILD', s2_monomorphic(hc), 'HostChild.execute', moduleUri, isPatch: false);
  shape('3_helper_chain', 'HOST-CHILD', s3_chain_a(hc), 'HostChild.execute', moduleUri, isPatch: false);
  shape('4_bounded_generic', 'HOST-CHILD', s4_generic<Base>(hc), 'HostChild.execute', moduleUri, isPatch: false);
  s5_field = hc;
  shape('5_field_receiver', 'HOST-CHILD', s5_fieldCall(), 'HostChild.execute', moduleUri, isPatch: false);
