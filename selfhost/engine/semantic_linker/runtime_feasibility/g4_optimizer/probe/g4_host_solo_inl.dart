...
const String host = 'package:dynamic_modules/g4_host_solo_inl.dart';

class Base {
  // never-inline REMOVED on purpose. In the solo arms the bypass took the form
  // of devirtualization to a direct call, because this pragma forbade inlining.
  // #41 asks for inlining to be exercised too, so this arm lets the optimizer
  // inline the body outright and asks whether the contract still holds.
