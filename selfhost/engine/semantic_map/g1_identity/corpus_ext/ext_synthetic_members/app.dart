...
mixin Doubler {
  int base();
  int doubledViaMixin() => base() * 2;
}

/// No declared constructor: the CFE generates one. Mixin application also
/// generates forwarders, both of which are synthetic members.
class Mixed with Doubler {
  @override
  int base() => 21;
}
