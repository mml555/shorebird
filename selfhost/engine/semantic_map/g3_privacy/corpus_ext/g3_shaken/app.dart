...
/// NEVER REFERENCED. --aot tree-shakes it, so the release does not retain it.
/// A patch naming it must be refused for NOT_RETAINED -- which is a different
/// refusal from "not private" and has a different remedy (re-release).
int _shakenAway(int x) => x * 7;
