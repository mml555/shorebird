...
class Target {
  /// Declared explicitly, and WITHOUT a pragma, so the confound demonstrator can
  /// differ from this file by exactly one annotation. The unnamed constructor is
  /// the declaration the VM resolves first when a module instantiates a subtype,
  /// so it is where withholding `callable` actually bites.
  Target();
